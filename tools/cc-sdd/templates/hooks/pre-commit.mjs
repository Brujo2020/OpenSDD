...
const resolveShimTarget = (fs, path, shim) => {
  ...
  const layouts = [
    ['..', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'],
    ['..', 'open-sdd', 'dist', 'cli.js'],
    ['..', '@brujo2020', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'],
    ['..', '@brujo2020', 'open-sdd', 'dist', 'cli.js'],
    ['node_modules', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'],
    ['node_modules', '@brujo2020', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'],
    ['..', 'lib', 'node_modules', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'],
    ['..', 'lib', 'node_modules', '@brujo2020', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'],
  ];
