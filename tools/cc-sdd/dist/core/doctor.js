...
const manifestCandidates = (cwd) => {
    const candidates = [
        ...
        path.join(cwd, 'tools', 'cc-sdd', 'package.json'),
...
const CLI_CANDIDATES = (cwd) => Array.from(new Set([
    ...
    path.join(cwd, 'tools', 'cc-sdd', 'dist', 'cli.js'),
    path.join(cwd, 'dist', 'cli.js'),
    path.join(cwd, 'node_modules', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'),
    path.join(cwd, 'node_modules', '@brujo2020', 'open-sdd', 'tools', 'cc-sdd', 'dist', 'cli.js'),
...
const HOOK_TEMPLATE_CANDIDATES = (cwd) => {
    const bases = [
        ...
        path.join(cwd, 'tools', 'cc-sdd', 'templates', 'hooks'),
        path.join(cwd, 'node_modules', 'open-sdd', 'tools', 'cc-sdd', 'templates', 'hooks'),
        path.join(cwd, 'node_modules', '@brujo2020', 'open-sdd', 'tools', 'cc-sdd', 'templates', 'hooks'),
    ];
    const out = [];
...
const checkCli = async (cwd) => {
    ...
    return {
        ...
        fix: 'Instala o compila el CLI: `npx open-sdd@latest --version` (o `npm --prefix tools/cc-sdd run build` en un checkout).',
    };
};
