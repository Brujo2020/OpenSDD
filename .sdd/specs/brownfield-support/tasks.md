- [x] 9. Generated artifacts of the brownfield change — _Requirements: REQ-BF-001, REQ-BF-002, REQ-BF-003, REQ-BF-005, REQ-BF-006_ — _Boundary:_ `tools/cc-sdd/dist`_
  - The compiled CLI is committed so the published package and a git clone both run without a build.
  - _Evidence: `tools/cc-sdd/dist/{core/{deltaSpec,constitution,reverseConstitution,rigor}.js,cli/commands/brownfield.js}` are rebuilt from the sources of this change; the drift check treats them as part of the declared boundaries._
- [x] 10. Fix the false ambient-drift paths — _Requirements: REQ-BF-003_ — _Boundary:_ `tools/cc-sdd/src/core/git.ts`_
...
- [-] 12. Impact analysis of a change — _Requirements: REQ-BF-007_ — _Boundary:_ `tools/cc-sdd/src/core/changeImpact.ts`, `tools/cc-sdd/test/coreChangeImpact.test.ts`_
...
- [-] 13. Execution contracts as the regression oracle — _Requirements: REQ-BF-008_ — _Boundary:_ `tools/cc-sdd/src/core/executionContract.ts`, `tools/cc-sdd/test/coreExecutionContract.test.ts`, `.github/workflows/gates.yml`_
...
- [-] 14. Reuse-first as a checkable rule — _Requirements: REQ-BF-009_ — _Boundary:_ `tools/cc-sdd/src/core/reuseFirst.ts`, `tools/cc-sdd/test/coreReuseFirst.test.ts`_
...
- [x] 15. Require the constitution at the commit and pull-request boundaries — _Requirements: REQ-BF-006_ — _Boundary:_ `tools/cc-sdd/templates/hooks/pre-commit`, `.github/workflows/gates.yml`, `scripts/install-hooks.mjs`, `tools/cc-sdd/src/cli/commands/paper.ts`_
...
- [x] 1. Delta engine: ADSR model, validation and traceability — _Requirements: REQ-BF-001, REQ-BF-004_ — _Boundary:_ `tools/cc-sdd/src/core/deltaSpec.ts`_
  ...
  - _Evidence: `node tools/cc-sdd/dist/cli.js delta validate brownfield-support` → 0 errors; the delta parser ignores HTML comment blocks so a scaffold's commented example is not read as a requirement._

- [x] 2. The shared constitution model — _Requirements: REQ-BF-002_ — _Boundary:_ `tools/cc-sdd/src/core/constitution.ts`_
...
- [x] 3. Reverse-engineered descriptive constitution — _Requirements: REQ-BF-002_ — _Boundary:_ `tools/cc-sdd/src/core/reverseConstitution.ts`_
...
- [x] 4. Workspace-aware and configuration-aware reconnaissance — _Requirements: REQ-BF-003_ — _Boundary:_ `tools/cc-sdd/src/core/reverseEngineering.ts`_
...
- [x] 5. Brownfield console surface — _Requirements: REQ-BF-005_ — _Boundary:_ `tools/cc-sdd/src/cli/commands/brownfield.ts`, `tools/cc-sdd/src/index.ts`_
...
- [x] 6. Regression tests for the brownfield core and console — _Requirements: REQ-BF-001, REQ-BF-002, REQ-BF-003, REQ-BF-004, REQ-BF-005_ — _Boundary:_ `tools/cc-sdd/test`_
