# Design (declared alias)

The canonical architecture document for this specification is [`plan.md`](./plan.md), which is the
name the reference architecture uses for the second element of the Documentary Triad
